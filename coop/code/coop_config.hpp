...
constexpr auto _COOP_SETTINGS_COOP_KNOCKBACK_NPC_OBJECTS = 0.75f;
constexpr auto _COOP_SETTINGS_COOP_KNOCKBACK_PROJECTILE = 0.35f;
constexpr auto _COOP_SETTINGS_COOP_KNOCKBACK_PLAYER = 0.85f;
